...
@interface GuiBDetailViewController ()
@property (nonatomic, strong) TPKeyboardAvoidingScrollView *scrollview;
@property (nonatomic, strong) GuiBDetailHeadView *headView;
...
@implementation GuiBDetailViewController{
    UIView *numView;
    UILabel *numTitle;
    UILabel *numberLab;
...
- (void)setModel:(GuiBAddTrainModel *)model{
    _model = model;
...
- (GuiBDetailHeadView *)headView{
    if (!_headView) {
        _headView = [[GuiBDetailHeadView alloc] initWithFrame:CGRectMake(0, 0, GB_ScreenWidth, 220)];
    }
    return _headView;
}
