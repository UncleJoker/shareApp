...
@interface GuiBTutorialViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation GuiBTutorialViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    GuiBTutorTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"TutorialCell" forIndexPath:indexPath];
...
- (UITableView *)list{
    if (!_list) {
        ...
        [_list registerClass:[GuiBTutorTableViewCell class] forCellReuseIdentifier:@"TutorialCell"];
    }
    return _list;
}
