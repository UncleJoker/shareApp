//
//  GBEditUserInfoViewController.m
//  GuideBook
//
...
#import "GBUserInfoTableViewCell.h"
#import "OAImagePickUtil.h"
#import "YYImageClipViewController.h"

@interface GBEditUserInfoViewController ()<UITableViewDelegate,UITableViewDataSource,OAImagePickUtilDelegate,YYImageClipDelegate>
...
@implementation GBEditUserInfoViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    GBUserInfoTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"UserInfoCell" forIndexPath:indexPath];
...
- (UITableView *)list{
    if (!_list) {
        ...
        [_list registerClass:[GBUserInfoTableViewCell class] forCellReuseIdentifier:@"UserInfoCell"];
